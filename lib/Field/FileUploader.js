...
var FileUploader = function FileUploader(_ref3) {
  ...
  thumbset[config.name] = _lodash["default"].unionBy(thumbs_new, thumbset[config.name], 'path');
...
var _default = exports["default"] = FileUploader; //export default React.memo(FileUploader)
